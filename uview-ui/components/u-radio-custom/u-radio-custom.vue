<template>
	<view class="u-radio-custom" :style="[radioStyle]" :class="[iconClass]">
		...
		<view class="u-radio-custom__label" @tap="onClickLabel" :style="{
...
<script>
	...
	export default {
		...
		created() {
			...
			this.parent = this.$u.$parent.call(this, 'u-radio-group-custom');
		},
		computed: {
			...
			iconClass() {
				let classes = [];
				classes.push('u-radio-custom__icon-wrap--' + this.shape);
				if (this.name == this.parent.value) classes.push('u-radio-custom__icon-wrap--checked');
				if (this.elDisabled) classes.push('u-radio-custom__icon-wrap--disabled');
				if (this.name == this.parent.value && this.elDisabled) classes.push(
					'u-radio-custom__icon-wrap--disabled--checked');
...
<style lang="scss" scoped>
	...
	.u-radio-custom {
		...
		&.u-radio-custom__icon-wrap--checked {
			color: $u-type-primary;
			background-color: $u-type-primary-light;
			border-color: $u-type-primary-light;
			.u-radio-custom__label {
				word-wrap: break-word;
				// margin-left: 10rpx;
				// margin-right: 24rpx;
				color: $u-type-primary;
		...
		&.u-radio-custom__icon-wrap--disabled{
			opacity: 0.8;
		}
